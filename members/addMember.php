...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($input_joinDate)){
        $joinDate_err = "Please enter a join date.";     
        ...
        $joinDate_err = "Please enter a join date that is in the present or past.";  
    }else{
    ...
    if(empty($input_birthday)){
        ...
        $birthday_err = "Please enter a birthday that is in the present or past.";  
    }else{
    ...
    if(empty($name_err) && empty($joinDate_err) && empty($address_err) && empty($birthday_err) && empty($phone_err)){
        // Prepare an insert statement
        $sql = "INSERT INTO Members (name, address, phone, joinDate, birthday) VALUES (?, ?, ?, ?, ?)";
         
        if($stmt = mysqli_prepare($conn, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssss", $param_name, $param_address, $param_phone, $param_joinDate, $param_birthday);
      ...
      <div class="row">
          <div class="col-md-12">
            <div class="page-header">
              <h2 class="my-2">Add Member</h2>
            </div>
              <p>Please fill this form and submit to add Members into the database.</p>
